...
GO
/****** Object:  StoredProcedure [dbo].[uspRED2RPL]    Script Date: 01/11/2016 21:18:52 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[uspRED2RPL]
...
AS
-- add the RED records for both the subscriber
...
'QCDRED-QCD', tmpExportAllAmerican.EIDTEFF, tmpExportAllAmerican.EIDTCVEF, tmpExportAllAmerican.EIDTCVEN, 
...
WHERE (((tmpExportAllAmerican.EISBRID)= @SubscriberID ) AND ((tmpExportAllAmerican.EINMPLAN)='QCDRPL-QCD'))

-- term the red coverages
...
-- the new red plus records are already there
