...
/****** Object:  StoredProcedure [dbo].[usp_InvoicePostIndivAll]    Script Date: 01/11/2016 21:06:36 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[usp_InvoicePostIndivAll]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[usp_InvoicePostIndivAll]
GO
