...
GO
/****** Object:  StoredProcedure [dbo].[usp_IndividualInvoice_One_csv]    Script Date: 01/11/2016 21:18:52 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[usp_IndividualInvoice_One_csv] 
				(			
...
/* ======================================================================================
  Object:			usp_IndividualInvoice_One_csv
  Version:			1.0
...
/*  ------------------------------------------------------  */
    ...
    BEGIN TRY
		BEGIN TRANSACTION
			...
			*/
			...
			SET @ssispath = '\\dc\datafiles\QuickBooks\SSIS\QuickBooks\SalesReceiptsOneOff_dev.dtsx'
	...
	END CATCH;
GO
EXEC sys.sp_addextendedproperty @name=N'Purpose', @value=N'Runs SSIS package to export Individual invoices to QuickBooks...' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'PROCEDURE',@level1name=N'usp_IndividualInvoice_One_csv'
GO
