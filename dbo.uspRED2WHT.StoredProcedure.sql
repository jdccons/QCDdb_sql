...
GO
/****** Object:  StoredProcedure [dbo].[uspRED2WHT]    Script Date: 01/11/2016 21:18:52 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[uspRED2WHT]
...
WHERE (((tmpExportAllAmerican.EISBRID)= @SubscriberID ) AND ((tmpExportAllAmerican.EINMPLAN)='QCDWHT-QCD'))
...
-- the new white records are already there
