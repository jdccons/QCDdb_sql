...
GO
/****** Object:  StoredProcedure [dbo].[uspWHT2RPL]    Script Date: 01/11/2016 21:18:52 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[uspWHT2RPL]
...
WHERE (((tmpExportAllAmerican.EISBRID)= @SubscriberID ) AND ((tmpExportAllAmerican.EINMPLAN)='QCDRPL-MNL'))
end
